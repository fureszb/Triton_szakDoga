  ...
  <tr>
    <td style="padding:32px 36px 16px;">
      ...
      <p style="margin:0;font-size:14px;color:#64748b;line-height:1.7;">
        ...
        Emlékeztetjük, hogy az alábbi megrendeléshez tartozó fizetési határidő közeleg.
        Kérjük, rendezze a fennálló összeget időben.
      </p>
    </td>
  </tr>
    ...
    <td style="padding:0 36px 24px;">
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#fdf6ee;border-radius:10px;border:1px solid rgba(201,169,122,0.25);overflow:hidden;">
        <tr style="background:rgba(201,169,122,0.12);">
          <td colspan="2" style="padding:12px 18px;font-size:12px;font-weight:700;color:#a07848;text-transform:uppercase;letter-spacing:0.8px;">Megrendelés adatai</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="padding:11px 18px;font-size:13px;color:{{ $napokHatra <= 1 ? '#dc2626' : '#334155' }};font-weight:{{ $napokHatra <= 1 ? '700' : '500' }};">
            {{ $megrendeles->FizetesiHatarido?->format('Y. m. d.') }}
            ({{ $napokHatra }} nap múlva)
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td style="background:#1e293b;padding:16px 36px;border-top:3px solid #c9a97a;">
      <p style="margin:0;font-size:11px;color:#64748b;text-align:center;">
        © {{ date('Y') }} TRITON SECURITY KFT. – Automatikusan generált email.
      </p>
    </td>
  </tr>
