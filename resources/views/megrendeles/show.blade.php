    ...
    @if ($megrendeles)
        ...
        <div class="container">
            <div class="row">
                ...
                <a href="{{ url('/download-pdf/' . $megrendeles->ugyfel->Ugyfel_ID . '/' . urlencode($megrendeles->ugyfel->Nev) . '/' .  $munka->szolgaltatas->Szolgaltatas_ID) }}" target="_blank">PDF Letöltése</a>
