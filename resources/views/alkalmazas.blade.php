...
<head>
   ...
   <link href='https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css' rel='stylesheet'>
    ...
    <link rel="stylesheet" href="{{ asset('alkalmazas.css') }}">
 ...
 <style>
        ...
        *,
        ...
        body form {
            ...
            box-shadow: 0px 4px 15px 4px #80808030;
        }
        body form label{
        ...
        /* Additional styles to make the search bar more like the one in the image */
        .search-container {
            max-width: 480px;
        ...
        .search-input {
            ...
            /* Rounded border */
            padding-left: 2.5rem;
            /* Space for the magnifying glass icon */
        }
...
<body className='snippet-body'>
    ...
    <body id="body-pd" style="background-color: #f1f5f9;">
        <header class="header" id="header">
            <div class="header_toggle"> <i class='bx bx-menu' id="header-toggle"></i> </div>
            <div class="container py-5">
                <div class="search-container position-relative">
                    <i class="bi bi-search text-muted"></i>
                    <input type="text" class="form-control search-input" placeholder="Press / to search">
                </div>
            </div>
        </header>
        ...
        <div class="height-100 bg-light" style="background-color: #f1f5f9 !important; margin-bottom: 8%;">
